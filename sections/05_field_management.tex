...
parameter/variable. The FieldRegistration includes a field ID, the datatype of the field, and 
a human-readable name. The name and field ID have to be unique per node. The first bit of paramter field IDs is 0 and the first bit of variable field IDs is 1. From this point on, the server knows which fields the node has.
