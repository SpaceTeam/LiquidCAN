...
\midrule
tel\_cnt & 1 & Number of telemetries on this node \\
...
Registration information for a telemetry or parameter field.
...
Response with requested field id and a status byte which shows if the node has found the field name.
\\
\begin{center}
\begin{tabular}{l c l}
\toprule
Field & Bytes & Description \\
\midrule
status & 1 Byte & Status byte (0=not found, 1=found) \\
field\_id & 1 Byte & Field ID \\
\midrule
\textbf{Total} & \textbf{63} & \\
\bottomrule
\end{tabular}
